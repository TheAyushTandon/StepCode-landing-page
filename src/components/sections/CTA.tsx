            ...
            >
              {!isExpanded ? (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="bg-[#C1121F] hover:bg-[#C1121F]/90 text-white px-6 py-3 rounded-full text-xs font-black uppercase tracking-wider flex items-center justify-center gap-1.5 shrink-0 transition-all duration-200 cursor-pointer active:scale-95"
                  >
                    JOIN WAITLIST
